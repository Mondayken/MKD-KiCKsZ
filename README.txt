...
4) Custom Domain (Vercel Default):
   - Site is accessible at https://mkdkicksz.vercel.app/
   - For a custom domain, register on a provider like Namecheap and add to Vercel.

5) Vercel (mirror + serverless):
   - Connect site to same GitHub repo (Vercel -> Dashboard -> New Project -> Import from Git)
   ...
   - Vercel will deploy. Serverless functions live under /api/orders and /api/payfast
